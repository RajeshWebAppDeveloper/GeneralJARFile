    ...
    BEGIN
        ...
        FOR customerCarsInfoList IN
            SELECT
                ...
                ,m2.category
                ,m2.no_of_seat
                ,m4.no_of_km_per_given_date::VARCHAR AS is_gps
                ,m2.transmission_type
                ,m2.fuel_type
                ,m2.extra_travel_km_per_price
                ,m4.car_rent_plan_price_per_given_date::VARCHAR AS price_per_day
                ,m2.branch
            FROM
            ...
            LEFT OUTER JOIN LATERAL (
                SELECT
                    ROUND((m3.car_rent_plan_price_per_hour * noOfHours)) AS car_rent_plan_price_per_given_date
                    ,ROUND((planKmPerHour * noOfHours)) AS no_of_km_per_given_date
            ) m4 ON TRUE
            WHERE
